...
const ProjectPage: NextPage<ProjectProps> = ({project, randomThreeProjects}) => {
  ...
  <svg width="${w}" height="${h}" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <defs>
      <linearGradient id="g">
        <stop stop-color="#f7f7f725" offset="20%" />
        <stop stop-color="#EEEEEE25" offset="50%" />
        <stop stop-color="#f7f7f725" offset="70%" />
      </linearGradient>
    </defs>
    <rect width="${w}" height="${h}" fill="#f7f7f725" fillOpacity="0.25" />
    <rect id="r" width="${w}" height="${h}" fill="url(#g)" fillOpacity="0.25" />
